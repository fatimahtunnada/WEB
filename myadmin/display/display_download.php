                  	...
                  	<div class="col-lg-12">
                      	<section class="panel">
                          	<header class="panel-heading">
                          		...
                          		<a href="beranda.php?page=input_download"><button class="btn btn-primary">Tambah</button></a><br>
                    		...
                    		<table class="table table-striped table-advance table-hover">
                        		<tbody>
									...
									<tr>
										...
										<td>
											<a href="edit_download.php?id=<?php echo $data['id']; ?>"><button class="btn btn-primary"><i class="fa fa-edit"></i></button></a>
											<a onclick="return confirm('Apakah Anda Yakin Menghapus ?')" href="proses/proses_hapus_download.php?id=<?php echo $data['id']; ?>"><button class="btn btn-danger"><i class="fa fa-trash-o"></i></button></a>
										</td>								
                              		</tr>
	        						<?php } ?>
								</tbody>
