<?php 
  ...
  $id=$_GET['id'];
  $query=mysqli_query($koneksi, "SELECT * FROM kajian WHERE id_kajian=$id");
            ...
            <div class="col-lg-12">
              <section class="panel">
                  <header class="panel-heading">
                    ...
                    <form action="proses/proses_edit_kajian.php" method="POST">
                      <input type="hidden" name="id" value="<?php echo $data['id_kajian'];?>">
                      <table cellpadding="0" cellspacing="0" border="0" width="90%">
                        ...
                        <tr>
                          <td>Judul Kajian</td>
                          <td><input type="text" name="judul" value="<?php echo $data['judul_kajian']; ?>"></td>
                        </tr>
                        <tr>
                          <td>Pembuat</td>
                          <td><input type="text" name="pembuat" value="<?php echo $data['pembuat']; ?>"></td>
                        </tr>
                        <tr>
                          <td>Kategori</td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="col-sm-20">
                              <textarea class="form-control ckeditor" name="isi" rows="6"><?php echo $data['isi_kajian']; ?></textarea>
                            </div>
                          </td>
                        </tr>
                        <tr>
