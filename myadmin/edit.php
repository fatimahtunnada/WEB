            ...
            <div class="col-lg-12">
              <section class="panel">
                  <header class="panel-heading">
                    ...
                    <form action="proses/proses_edit.php" enctype="multipart/form-data" method="POST">
                      ...
                      <table cellpadding="0" cellspacing="0" border="0" width="90%">
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="col-sm-20">
                              <textarea class="form-control ckeditor" name="isi" rows="6"><?php echo $data['isi']; ?></textarea>
                            </div>
                          </td>
                        </tr>
                        <tr>
