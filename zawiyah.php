...
<body id="top">
   ...
   <section id="bricks">
   	...
   	<div class="row masonry">
		   ...
		   <!-- brick-wrapper -->
		   <a href="input_anggota.php"><input type="button" name="input" value="Daftar"></a>
							...
							<table class="table table-striped table-advance table-hover">
           		                <tbody>
                            		<tr>
                                 		...
                                 		<th width="20%"><i class="icon_clock"></i> Nama</th>
                                 		<th width="15%"><i class="icon_map_alt"></i> Jenis kelamin</th>
                                 		<th width="15%"><i class="icon_book_alt"></i> Agama</th>
                                        <th width="18%"><i class="icon_book_alt"></i> Tanggal Lahir</th>
                                 		<th width="14%"><i class="icon_tag"></i> Telephone</th>
                                 		<th width="20%"><i class="icon_camera"></i> Email</th>
                                 		<th width="30%"><i class="icon_mobile"></i> Alamat</th>
                            		</tr>
									<?php
										include "mysqli_koneksi.php";
										$no=1;
										$sql=mysqli_query($con, "SELECT * FROM pendaftar ORDER BY id DESC");
