   	...
   	<div class="row header-content">
	   	...
	   	<nav id="main-nav-wrap">
				<ul class="main-navigation sf-menu">
					...
					<li class="current"><a href="jadwal.php" title="">Jadwal</a></li>	
			...
			<table class="table table-striped table-advance table-hover">
           		                <tbody>
                            		<tr>
                                 		...
                                 		<th width="20%"><i class="icon_clock"></i> Hari</th>
                                 		<th width="15%"><i class="icon_map_alt"></i> Tanggal</th>
                                 		<th width="15%"><i class="icon_book_alt"></i> Waktu</th>
                                        <th width="18%"><i class="icon_book_alt"></i> Tempat</th>
                                 		<th width="14%"><i class="icon_tag"></i> Kegiatan</th>
                                 		
                            		</tr>
									<?php
										include "mysqli_koneksi.php";
										$no=1;
										$sql=mysqli_query($con, "SELECT * FROM jadwal ORDER BY id DESC");
